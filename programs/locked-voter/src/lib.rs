...
pub mod locked_voter {
    ...
    pub fn lock<'info>(
        ...
        msg!("Warning: this instruction is deprecated in favor of `lock_with_whitelist`, `lock_with_whitelist_entry`, or `lock_permissionless`. Please update your Structa SDK.");
