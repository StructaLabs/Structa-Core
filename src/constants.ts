...
/**
 * Structa program types.
 */
export interface StructaPrograms {
...
export const STRUCTA_ADDRESSES = {
 ...
 * Coders.
 */
export const STRUCTA_CODERS = buildCoderMap<{
  SimpleVoter: SimpleVoterTypes;
  Govern: GovernTypes;
  LockedVoter: LockedVoterTypes;
}>(STRUCTA_IDLS, STRUCTA_ADDRESSES);
